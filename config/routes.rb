Rails.application.routes.draw do
  ...
  # DELETE
  get("/delete_like/:fan_id/:photo_id", { :controller => "likes", :action => "destroy" })
  ...
  # DELETE
  get("/delete_follow_request/:sender_id/:receiver_id", { :controller => "follow_requests", :action => "destroy" })
